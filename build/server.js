...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _reactDomServer = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _fbjsLibInvariant = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _coreLocation = __webpack_require__(29);
  	...
  	_createClass(Navigation, [{
  		...
  		value: function render() {
  			return _react2['default'].createElement(
  				...
  				_react2['default'].createElement('i', { className: 'fa fa-bars menu-button', onClick: this.props.toggleMenu })
  			);
  		}
  	}], [{
  		key: 'propTypes',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _AppCss = __webpack_require__(34);
  
  var _AppCss2 = _interopRequireDefault(_AppCss);
  
  var _decoratorsWithContext = __webpack_require__(30);
  ...
  var App = (function (_Component) {
  	...
  	_createClass(App, [{
  		...
  		key: 'renderPage',
  		value: function renderPage(left) {
  			return !this.props.error ? _react2['default'].createElement(
  				...
  				_react2['default'].createElement(
  					...
  					_react2['default'].createElement(_Sidebar2['default'], { toggleMenu: this.toggleMenu })
  				),
  				_react2['default'].createElement(
  					'div',
  					{ className: 'App-app', style: { left: left } },
  					_react2['default'].createElement(_Header2['default'], null),
  					_react2['default'].createElement(_Navigation2['default'], { toggleMenu: this.toggleMenu }),
  					_react2['default'].createElement(
  						'div',
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _BillPayPageCss = __webpack_require__(35);
  
  var _BillPayPageCss2 = _interopRequireDefault(_BillPayPageCss);
  
  var _decoratorsWithStyles = __webpack_require__(2);
  
  var _decoratorsWithStyles2 = _interopRequireDefault(_decoratorsWithStyles);
  
  var BillPayPage = (function (_Component) {
    _inherits(BillPayPage, _Component);
  
    function BillPayPage() {
      _classCallCheck(this, _BillPayPage);
  
      _get(Object.getPrototypeOf(_BillPayPage.prototype), 'constructor', this).apply(this, arguments);
    }
  
    _createClass(BillPayPage, [{
      key: 'render',
      value: function render() {
        var title = 'Bill Pay';
        ...
        return _react2['default'].createElement(
          'div',
          { className: 'BillPayPage' },
          _react2['default'].createElement(
            'div',
            { className: 'BillPayPage-container' },
            _react2['default'].createElement(
              'h1',
              null,
              title
    ...
    var _BillPayPage = BillPayPage;
    BillPayPage = (0, _decoratorsWithStyles2['default'])(_BillPayPageCss2['default'])(BillPayPage) || BillPayPage;
    return BillPayPage;
  })(_react.Component);
  
  exports['default'] = BillPayPage;
  module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _decoratorsWithViewport = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _SidebarCss = __webpack_require__(46);
  
  var _SidebarCss2 = _interopRequireDefault(_SidebarCss);
  ...
  var Navigation = (function (_Component) {
  	...
  	function Navigation() {
  		...
  		_get(Object.getPrototypeOf(_Navigation.prototype), 'constructor', this).call(this);
  		this.handleClick = this.handleClick.bind(this);
  	}
  
  	_createClass(Navigation, [{
  		key: 'handleClick',
  		value: function handleClick(click) {
  			_Link2['default'].handleClick(click);
  		...
  		value: function render() {
  			return _react2['default'].createElement(
  				'div',
  				{ className: (0, _classnames2['default'])(this.props.className, 'Sidebar') },
  				_react2['default'].createElement(
  					'div',
  					{ className: 'Sidebar-menu', onClick: this.props.toggleMenu },
  					_react2['default'].createElement(
  						'h1',
  						null,
  						'Menu'
  					...
  					_react2['default'].createElement(
  						'a',
  						{ href: '/files', onClick: this.handleClick },
  						_react2['default'].createElement(
  							'div',
  							{ className: 'menu-item' },
  							'Files'
  	...
  	var _Navigation = Navigation;
  	Navigation = (0, _decoratorsWithStyles2['default'])(_SidebarCss2['default'])(Navigation) || Navigation;
  	return Navigation;
  })(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _fbjsLibEmptyFunction = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _coreHttpClient = __webpack_require__(28);
  ...
  var _componentsRegisterPage = __webpack_require__(25);
  
  var _componentsRegisterPage2 = _interopRequireDefault(_componentsRegisterPage);
  
  var _componentsBillPayPage = __webpack_require__(15);
  
  var _componentsBillPayPage2 = _interopRequireDefault(_componentsBillPayPage);
  ...
  var router = new _reactRoutingSrcRouter2['default'](function (on) {
  	...
  	on('/bill-pay', function callee$1$0() {
  		return regeneratorRuntime.async(function callee$1$0$(context$2$0) {
  			while (1) switch (context$2$0.prev = context$2$0.next) {
  				case 0:
  					return context$2$0.abrupt('return', _react2['default'].createElement(_componentsBillPayPage2['default'], null));
