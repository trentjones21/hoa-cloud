...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
		...
		setNavigation: function (items, path) {
			if (items) this.setState({ navigationItems: items });
			if (path) this.setState({ navigationPath: path });
		},
		render: function () {
			var self = this;
			...
			return React.createElement(
				...
				React.createElement(Navigation, { toggleMenu: this.toggleMenu, items: this.state.navigationItems, path: this.state.navigationPath }),
				React.createElement(
					"div",
					{ className: "container" },
					childrenWithProps
			...
			return React.createElement(
				...
				React.createElement(
					...
					this.state.announcements.map(function (announcement) {
						return React.createElement(
							'div',
							{ key: announcement.title, className: 'announcement' },
							React.createElement(
								'h2',
								null,
								announcement.title
